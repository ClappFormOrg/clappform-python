...
class ExecuteRequest(_message.Message):
    __slots__ = ("process_id", "inputs", "response_mode", "response", "outputs")
    PROCESS_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, process_id: _Optional[str] = ..., inputs: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., response_mode: _Optional[str] = ..., response: _Optional[str] = ..., outputs: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
...
class ProcessSummary(_message.Message):
    __slots__ = ("id", "title", "description", "version", "job_control_options", "output_transmission", "metadata", "links")
    ...
    links: _containers.RepeatedCompositeFieldContainer[Link]
    def __init__(self, id: _Optional[str] = ..., title: _Optional[str] = ..., description: _Optional[str] = ..., version: _Optional[str] = ..., job_control_options: _Optional[_Iterable[str]] = ..., output_transmission: _Optional[_Iterable[str]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., links: _Optional[_Iterable[_Union[Link, _Mapping]]] = ...) -> None: ...
