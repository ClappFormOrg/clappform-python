...
class User(_message.Message):
    __slots__ = ("id", "email", "first_name", "last_name", "is_active", "last_online", "extra_information", "otp_enabled", "created_at", "updated_at", "deleted_at", "roles")
...
class CreateRequest(_message.Message):
    __slots__ = ("email", "first_name", "last_name", "password", "is_active", "extra_information", "roles")
    EMAIL_FIELD_NUMBER: _ClassVar[int]
    FIRST_NAME_FIELD_NUMBER: _ClassVar[int]
    LAST_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    extra_information: bytes
    roles: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, email: _Optional[str] = ..., first_name: _Optional[str] = ..., last_name: _Optional[str] = ..., password: _Optional[str] = ..., is_active: bool = ..., extra_information: _Optional[bytes] = ..., roles: _Optional[_Iterable[str]] = ...) -> None: ...

class UpdateRequest(_message.Message):
    __slots__ = ("id", "email", "first_name", "last_name", "password", "extra_information", "roles")
    ID_FIELD_NUMBER: _ClassVar[int]
    EMAIL_FIELD_NUMBER: _ClassVar[int]
    FIRST_NAME_FIELD_NUMBER: _ClassVar[int]
    LAST_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    extra_information: bytes
    roles: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, id: _Optional[str] = ..., email: _Optional[str] = ..., first_name: _Optional[str] = ..., last_name: _Optional[str] = ..., password: _Optional[str] = ..., extra_information: _Optional[bytes] = ..., roles: _Optional[_Iterable[str]] = ...) -> None: ...
