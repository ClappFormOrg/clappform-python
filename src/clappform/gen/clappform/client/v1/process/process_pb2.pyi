...
class ExecuteRequest(_message.Message):
    __slots__ = ("process_id", "inputs", "mode", "response")
    PROCESS_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    mode: str
    response: str
    def __init__(self, process_id: _Optional[str] = ..., inputs: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., mode: _Optional[str] = ..., response: _Optional[str] = ...) -> None: ...
